local repo = "https://raw.githubusercontent.com/AprilScript/April-Script/main/
...
local new = Tabs.new:AddLeftGroupbox('信息')
...
new:AddButton({
    ...
    Func = function()
        ...
        local Window = WindUI:CreateWindow({
            Title = gradient("April脚本   ", Color3.fromRGB(139, 0, 255), Color3.fromRGB(255, 0, 0)), 
...
local function updateWatermark()
    ...
    game:GetService('RunService').RenderStepped:Connect(function()
        ...
        Library:SetWatermark(string.format('April脚本 | %d FPS | %d ping ', math.floor(fps), math.floor(game:GetService('Stats').Network.ServerStatsItem['Data Ping']:GetValue())))
    end)
end
